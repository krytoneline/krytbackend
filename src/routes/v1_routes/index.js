...
router.post(
  "/UpdateWalletStatus",
  isAuthenticated(["USER", "ADMIN", "SELLER"]),
  user.UpdateWalletStatus,
);
router.post(
  "/deleteWalletRequest",
  isAuthenticated(["USER", "ADMIN", "SELLER"]),
  user.deleteWalletRequest,
);
router.get(
  "/getWalletRequest",
  isAuthenticated(["USER", "ADMIN", "SELLER"]),
...
router.post("/chargeCPC", setting.chargeCPC);
...
router.get(
  ...
  isAuthenticated(["ADMIN", "SELLER"]),
  dashboard.getMonthlyChartData,
);
router.get(
  "/dashboard/user-distribution",
  isAuthenticated(["ADMIN", "SELLER"]),
  dashboard.getUserDistribution,
);
